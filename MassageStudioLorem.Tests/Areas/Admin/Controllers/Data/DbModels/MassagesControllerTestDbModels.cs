namespace MassageStudioLorem.Tests.Areas.Admin.Controllers.Data.DbModels
{
    ...
    public class MassagesControllerTestDbModels
    {
        public static Massage TestMassage => new()
        {
            ...
            ShortDescription = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut leo quam, eleifend sit amet faucibus non, tempus et purus. Nullam nunc leo, varius vitae mauris ut, semper bibendum sapien.",
        ...
        public static Appointment TestUpcomingAppointment => new()
        {
            Id = TestMasseurData.Id,
            MasseurId = TestMasseurUserData.Id,
