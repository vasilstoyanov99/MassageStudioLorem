namespace MassageStudioLorem.Data
{
    ...
    public class LoremDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        private static readonly MethodInfo SetIsDeletedQueryFilterMethod =
            typeof(LoremDbContext).GetMethod(
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            var deletableEntityTypes = entityTypes
                .Where(et =>
                    et.ClrType != null && typeof(IDeletableEntity).IsAssignableFrom(et.ClrType) && et.BaseType == null);
